...
Possuo ampla experiência na gestão do ciclo de vida completo de entrega de software, garantindo que requisitos de negócios complexos sejam traduzidos em sistemas escaláveis e prontos para produção.

- 🏗️ **Design Arquitetural:** Projetando estruturas robustas de back-end e integrações.
- ⚙️ **Entrega de Ciclo Completo (Full-Cycle):** Proficiente em todo o pipeline, do desenvolvimento ao deploy.
- 💼 **Especialista em ERP:** Especialista em ambientes de negócios de alta complexidade (Protheus & Fluig).

---

### 🛠️ Competências Principais e Ecossistema ERP

#### **Foco Principal (TOTVS)**
